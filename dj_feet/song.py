...
class Song:
    ...
    def next_segment(self, segment_size, begin=False):
        ...
        of the song if `begin` is False. Get the first `segment_size` of the
        song otherwise.

        :param segment_size: The length of the next sector to get in seconds.
        :type segment_size: int
        :param begin: Whether the sector should be gotten from the song's
    ...
    def time_delta(self, start_frame, end_frame):
        ...
        :param start_frame: The index of the first sample.
        :type start_frame: int
        :param end_frame: The index of the last sample.
        :type end_frame: int
    ...
    def frame_to_segment_time(self, segment_size, start_frame):
        ...
        Find the index of a sample that is exactly `segment_size` seconds after
        the given `start_frame`. No guarantees are made that this given sample
        index is a valid index for the given song, this should be checked
        manually.

        :param segment_size: The time in seconds between the given
                             `start_frame` and the returned sample index.
        :type segment_size: int
        :param start_frame: The index of the sample to find the sample
                            `segment_size` seconds away from.
        :type start_frame: int
        :returns: A sample index that is `segment_size` seconds after the given
                  `start_frame`.
        :rtype: int
        """
    ...
    def beat_tracks_in_segment(self, seg_start, seg_end):
        ...
        :param seg_start: The sample index indicating the beginning of the
                          range to find beats on.
        :type seg_start: int
        :param seg_end: The sample index indicating the end of the range to
                        find beats on.
        :type seg_end: int
    ...
    def segment_size_left(self, segment_size):
        ...
        :param segment_size: The length in seconds of a segment.
        :type segment_size: int
